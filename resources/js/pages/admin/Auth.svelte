...
<div class="relative flex min-h-screen items-center justify-center bg-cover bg-center" style="background-image: url('/img/default/loginBackground.jpg')">
    <!-- Overlay escura -->
    <div class="absolute inset-0 bg-black opacity-50"></div>

    <!-- Conteúdo principal -->
    <div class="relative flex w-full max-w-xs flex-col items-center px-4">
        <img src="/img/default/logo.png" alt="Logo" class="w-[11rem]" loading="lazy"/>
