...
<section class="container border-t border-[var(--color-orange-amber)] bg-[var(--color-blue-indigo)] py-4">
    <div class="flex">
        <span class="hidden gap-2 items-end font-noto-sans text-[var(--color-orange-amber)] text-xl uppercase pr-6 border-r border-r-[rgba(229,231,235,0.3)] lg:flex">
            <img src="/icons/kbps.svg" alt="kpbs icon" class="w-8 color-filter-blue-skywave" />
            {data?.['plano_bitrate'] ?? '0 kbps'} 
        </span>
        <span class="hidden gap-2 items-end font-noto-sans text-[var(--color-orange-amber)] text-xl uppercase pl-6 pr-6 border-r border-r-[rgba(229,231,235,0.3)] lg:flex">
            <img src="/icons/satelite.svg" alt="satelite icon" class="w-8 color-filter-blue-skywave" />
            {data?.['status'] === 'Ligado' ? 'online' : 'offline'} 
        </span>
        <span class="flex gap-2 items-end font-noto-sans text-[var(--color-orange-amber)] text-xl uppercase lg:pl-6 lg:pr-6">
