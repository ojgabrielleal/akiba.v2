    ...
    <Section {title}>
        ...
        <div class="flex flex-wrap gap-2 mt-10">
            {#each requests as item}
                {#key tick}
                    <div
                        class={`w-[23.6rem] rounded-lg p-3 ${item.status === "finished" ? "bg-green-forest" : "bg-blue-skywave"}`}
                    >
                        <span
                            class="flex items-center gap-1.5 text-neutral-aurora text-[1.2rem] font-noto-sans font-bold italic"
                        >
                            <Icon
                        ...
                        <span
                            class="mt-1 flex gap-1.5 text-neutral-aurora text-[1rem] font-noto-sans"
                        >
                            <Icon
                        ...
                        <div class="flex gap-3">
                            <img
                                ...
                                alt="capa da musica"
                                class="w-15 h-15 rounded-lg object-cover object-top"
                            />
                            <div>
                                <span
                                    class="block text-neutral-aurora text-sm font-noto-sans"
                                >
                        ...
                        <div class="flex justify-between">
                            ...
                            {#if item.status === "new"}
                                <button
                                    onclick={() =>
                                        router.patch(
                                            `/painel/locucao/listenerrequestfinished/${item.id}`,
                                        )}
                                    class="cursor-pointer text-neutral-aurora"
                                >
                                    <Icon
